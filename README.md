...
____
## Для опытных
Если вы уверены, что у вас имеются все необходимые плагины (CLEO, SampFuncs, MoonLoader) и библиотеки, вы можете скачать скрипт одним файлом («Bank Helper.lua») и переместить его в папку «moonloader».
____
[:arrow_up: Оглавление](#оглавление) 
____
## Помощь
